  ...
  Knob = function(inputEl, callback) {
    ...
    */
    ...
    if (inputEl.hasAttribute('min')) {
      options.valueMin = parseInt(inputEl.getAttribute('min'));
    }
    if (inputEl.hasAttribute('max')) {
      options.valueMax = parseInt(inputEl.getAttribute('max'));
    }
    if (inputEl.hasAttribute('value')) {
      options.value = parseInt(inputEl.getAttribute('value'));
    }
    if (inputEl.hasAttribute('data-angle-start')) {
      options.angleStart = parseInt(inputEl.getAttribute('data-angle-start'));
    }
    if (inputEl.hasAttribute('data-angle-end')) {
      options.angleEnd = parseInt(inputEl.getAttribute('data-angle-end'));
    }
    if (inputEl.hasAttribute('data-angle-value-ratio')) {
      options.angleValueRatio = parseInt(inputEl.getAttribute('data-angle-value-ratio'));
    }
    if (inputEl.hasAttribute('data-angle-slide-ratio')) {
      options.angleSlideRatio = parseInt(inputEl.getAttribute('data-angle-slide-ratio'));
    }
